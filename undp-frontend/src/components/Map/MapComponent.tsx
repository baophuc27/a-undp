...
import { MapContainer as Map, TileLayer, Marker, GeoJSON } from 'react-leaflet';
...
const MapComponent: React.FC<MapContainerProps> = ({ additionalLayers = [] }) => {
  ...
  }, [map, calculateDistance, createBuffer, initializeWindy]);
